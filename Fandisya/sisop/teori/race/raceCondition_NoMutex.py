...
def tarik_uang(jumlah):
    ...
    if saldo >= jumlah:
        ...
        temp = saldo
        # Menunggu sejenak untuk mensimulasikan kondisi balapan
        time.sleep(0.1)
        saldo = temp - jumlah
...
t1 = threading.Thread(target=tarik_uang, args=(500,), name="Thread-1")
t2 = threading.Thread(target=tarik_uang, args=(800,), name="Thread-2")
