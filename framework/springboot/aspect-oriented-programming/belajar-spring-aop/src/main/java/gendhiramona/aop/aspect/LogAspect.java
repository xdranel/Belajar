package gendhiramona.aop.aspect;
...
public class LogAspect {
    ...
    @Pointcut("target(gendhiramona.aop.service.HelloService)")
    ...
    //use Object for Around
    //use ProceedingJoinPoint for Around
    //don't forget to throw Throwable
    ...
    @Pointcut("execution(* gendhiramona.aop.service.HelloService.*(java.lang.String))")
...
//    }
    ...
    @Pointcut("execution(* gendhiramona.aop.service.*.*(..))")
    ...
    @Pointcut("pointcutServicePackage() && pointcutServiceBean() && pointcutServiceMethod()")
