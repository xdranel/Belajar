...
public class OffsetTimeTest {
    ...
    void create() {
        ...
        OffsetTime offsetTime3 = OffsetTime.of(12, 30, 45, 0, ZoneOffset.ofHours(7));
        OffsetTime offsetTime4 = OffsetTime.parse("12:30:45+07:00");
        ...
        OffsetDateTime offsetDateTime2 = offsetDateTime1.atZoneSameInstant(ZoneId.of("Asia/Jakarta")).toOffsetDateTime();
        OffsetDateTime offsetDateTime3 = OffsetDateTime.of(LocalDateTime.now(), ZoneOffset.ofHours(7));
        OffsetDateTime offsetDateTime4 = OffsetDateTime.parse("2020-06-14T12:30:45+07:00");
